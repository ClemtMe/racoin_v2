...
#[AllowDynamicProperties] class ItemController {
    ...
    function afficherItem($twig, $menu, $chemin, $id, $cat): void
    {
    ...
    function supprimerItemGet($twig, $menu, $chemin, $id){
        $this->annonce = Annonce::find($id);
        if(!isset($this->annonce)){
            echo "404";
            return;
    ...
    function supprimerItemPost($twig, $menu, $chemin, $id, $cat){
        $this->annonce = Annonce::find($id);
        $reponse = false;
